...
const ArtistTopTracks = ({ artistInfo, authToken }) => {
  ...
  async function getTopTracks() {
    let response = await axios.get(
      `https://api.spotify.com/v1/artists/${artistInfo.id}/top-tracks?include_groups=tracks&market=US&limit=30`,
      {
        headers: {
  ...
  return (
    <div>
      ...
      <TableContainer
        component={Paper}
        sx={{ maxHeight: "425px", width: "600px" }}
      >
          ...
          <TableBody>
            {topTracks.map((track) => (
              ...
              >
                ...
                <TableCell>
                  <img src={track.album.images[2].url} alt="track album img" />
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
